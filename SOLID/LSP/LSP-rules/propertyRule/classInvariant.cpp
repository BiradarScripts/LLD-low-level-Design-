...
public:
    ...
    virtual void withdraw(double amount) {
        ...
        balance -= amount;
        cout<< "Amount withdrawn. Remaining balance is parent " << balance << endl;
    }
};
...
public:
    ...
    void withdraw(double amount) override {
        ...
        cout<< "Amount withdrawn. Remaining balance is child" << balance << endl;
    }
};

int main() {
    BankAccount* bankAccount = new CheatAccount(50);
